...
--
-- Name: problem_description; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX problem_description ON problems USING gin (to_tsvector('english'::regconfig, description));


--
-- Name: problem_title; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX problem_title ON problems USING gin (to_tsvector('english'::regconfig, (title)::text));
...
INSERT INTO schema_migrations (version) VALUES ('20120528135224');

INSERT INTO schema_migrations (version) VALUES ('20120528140320');

INSERT INTO schema_migrations (version) VALUES ('20120529080617');

INSERT INTO schema_migrations (version) VALUES ('20120530181016');

INSERT INTO schema_migrations (version) VALUES ('20120531114817');

INSERT INTO schema_migrations (version) VALUES ('20120531171704');

INSERT INTO schema_migrations (version) VALUES ('20120605121237');

INSERT INTO schema_migrations (version) VALUES ('20120605130459');
